...
- [ ] Describe Middleware?
Middleware connects two sides of an application and passes data between them. Has access to req and res and can tell call to excecute function at given point using next()
